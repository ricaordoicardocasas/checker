...
if (in_array($code, $messages)) { 
    ...
    echo "<span style='color:red;'> Reprovada</span> <span style='color:beige;'>$cc|$mes|$ano|$cvv</span> <span style='color:beige;'>$ReturnCode</span> <span style='color:beige;'>| N�O DEBITOU 12USD ";
}
