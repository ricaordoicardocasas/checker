...
if (in_array($code, $messages)) { 
    ...
    echo "<span style='color:green;'> Aprovada<span style='color:beige;'>$cc|$mes|$ano|$cvv</span> <span style='color:beige;'>$ReturnCode</span> <span style='color:beige;'>| DEBITOU 12USD|</span><br><span style='color:green;'>DADOS ULTILIZADOS: $email | $nome $sobrenome | $cep | $endereco | $cpf | E";
} else {
    echo "<span style='color:red;'> Reprovada</span> <span style='color:beige;'>$cc|$mes|$ano|$cvv</span> <span style='color:beige;'>$ReturnCode</span> <span style='color:beige;'>| NÃO DEBITOU 12USD|</span><br><span style='color:green;'>DADOS ULTILIZADOS: $email | $nome $sobrenome | $cep | $endereco | $cpf |";
}
